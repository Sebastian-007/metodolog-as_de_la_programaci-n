...
"""
   ...
   Ordenamiento permanente, es decir, ordena lista permanente.
...
"""
   Método reverse()
"""
motorcycles = ["mortalika", "honda", "ducatti"]
print(motorcycles)
motorcycles.reverse()
print(motorcycles)
...
print("Lista ordenada temporalmente al reves: ", sorted(favorite_students, reverse = True))
